      ...
      <article className={'w-full flex items-center justify-between rounded-3xl border border-solid border-dark bg-light shadow-2xl p-12 relative rounded-br-2xl'}>
          ...
          <Link href={link} target={'_blank'} className={'w-1/2 cursor-pointer overflow-hidden rounded-lg'}>
              ...
              <div className={'w-1/2 flex flex-col items-start justify-between pl-6'}>
                  <span className={'font-medium text-primary text-xl'}>{type}</span>
                  <Link href={link} target={'_blank'} className={'hover:underline underline-offset-2'}>
                      <h2 className={'my-2 text-left text-4xl font-bold'}>{title}</h2>
                  </Link>
                  <p className={'my-2 font-medium text-dark'}>{summury}</p>
      ...
      <article className={'w-full flex flex-col items-center justify-center rounded-2xl border border-solid border-dark bg-light p-6 relative '}>
          ...
          <div className={'w-full flex flex-col items-start justify-between mt-4'}>
              ...
              <div className={'w-full mt-2 flex items-center justify-between'}>
                  <Link className={'text-lg font-semibold underline'} href={link} target={'_blank'}>Visit</Link>
                  <Link className={'w-10'} href={github} target={'_blank'}> <GithubIcon/></Link>
              </div>
          </div>
      </article>
