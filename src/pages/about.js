...
const About = () => {
    return (
        <>
            <Head>
                <title>CodeBuks | About page</title>
                ...
                <Layout className={'pt-16'}>
                    ...
                    <div className={'grid w-full grid-cols-8 gap-16 sm:gap-8'}>
                        <div className={'col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8'}>
                            ...
                            <p className={'font-medium'}>Hi, I'm CodeBucks, a web developer and UI/UX designer with a
                        ...
                        <div className={'col-span-2 flex flex-col items-end justify-between xl:col-span-8 xl:flex-row xl:items-center md:order-3'}>
                            ...
                            <span className={'inline-block text-7xl font-bold md:text-6xl sm:text-5xl xs:text-4xl'}>
                                ...
                                <h2 className={'text-xl font-medium capitalize text-dark/75 dark:text-light/75 xl:text-center md:text-lg sm:text-base xs:text-sm'}>projects
                                    completed</h2>
                            </div>
                            ...
                            <AnimatedNumbers value={50}/>+
                                ...
                                <h2 className={'text-xl font-medium capitalize text-dark/75 dark:text-light/75 xl:text-center md:text-lg sm:text-base xs:text-sm'}>satisfied
                                    clients</h2>
                            </div>
                            ...
                            <AnimatedNumbers value={4}/>+
                                ...
                                <h2 className={'text-xl font-medium capitalize text-dark/75 dark:text-light/75 xl:text-center md:text-lg sm:text-base xs:text-sm'}>years
                                    exporianses</h2>
                            </div>
                        </div>
                    </div>
